...
- (void) StereoBinauralRendering:(int16_t *)inputFrame outBufferL:(int16_t *)outBufferL outBufferR:(int16_t *)outBufferR horiAngle:(int)horiAngle elevAngle:(int)elevAngle;
- (void) bufferFlush;
@end
