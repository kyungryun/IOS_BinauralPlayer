...
public final class JoyStickView: UIView {
    ...
    // HSUE : add on off to control joystick
    public var onoff: Bool = true
    ...
    private func initialize() {
        ...
        handleImageView.frame = bounds.insetBy(dx: 0.38 * bounds.width, dy: 0.38 * bounds.height)
     ...
     */
    // HSUE : change private to public (access from VideoViewController)
